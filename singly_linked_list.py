...
li.insert_at_position(1, 100)
li.insert_at_position(1, 200) 
li.insert_at_position(3, 300)
li.insert_at_position(5, 400) 

li.display()

li.delete_at_end()
li.delete_at_begining()
li.delete_at_position(2)
